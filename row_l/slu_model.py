...
class slu_model(object):
    ...
    def attention(self):
        ...
        self.tourist_input_intent = tf.multiply(self.tourist_input_intent, tf.reciprocal(tf.expand_dims(self.tourist_dist, axis=2)))
        self.guide_input_intent = tf.multiply(self.guide_input_intent, tf.reciprocal(tf.expand_dims(self.guide_dist, axis=2)))
