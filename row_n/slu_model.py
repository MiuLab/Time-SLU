...
class slu_model(object):
    ...
    def attention(self):
        ...
        tourist_hist = tf.multiply(tourist_hist, tf.reciprocal(tf.expand_dims(self.tourist_dist, axis=2)))
        guide_hist = tf.multiply(guide_hist, tf.reciprocal(tf.expand_dims(self.guide_dist, axis=2)))
